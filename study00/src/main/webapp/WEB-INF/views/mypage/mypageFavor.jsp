...
<body>
	...
	<script type="text/javascript">
		...
		var cnt = '${favorList.contentId }';
		$.ajax({
			url:"http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailCommon?ServiceKey="+ ServiceKey
				+ "&contentId="+ cnt + "&defaultYN=Y&firstImageYN=Y&areacodeYN=Y&catcodeYN=Y&addrinfoYN=Y&mapinfoYN=Y&overviewYN=Y&MobileOS=ETC&MobileApp=AppTest",
			success:function(data){				
				$(data).find('item').each(function(){					
					...
					var html = '';
					html += '<tr>';
					html += '<td><a href="/detail?contentid=${favorList.contentId }">';
					html += '<img class="img-fluid image" src="'+firstimage+'" style="width:200px; height:160px" ></a></td>';
					html += '<td><a href="/detail?contentid=${favorList.contentId }" style="color:black;"><strong>'+title+'</strong></a>';
