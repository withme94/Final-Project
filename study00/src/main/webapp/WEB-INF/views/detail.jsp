						...
						<div class="col-md-offset-3">
							<ul class="pagination">
								<c:if test="${pageMaker.prev}">
									<li><a
										href="detail${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
								</c:if>
								...
								<c:forEach begin="${pageMaker.startPage}"
									...
									<li
										...
										<a href="detail${pageMaker.makeSearch(idx)}&contentid=<%=request.getParameter("contentid") %>&areacode=<%=request.getParameter("areacode")%>&sigungucode=<%=request.getParameter("sigungucode")%>" class="page-link">${idx}</a>
									</li>
								</c:forEach>

								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
									<li><a
										href="detail${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
								</c:if>
							</ul>
						</div>
