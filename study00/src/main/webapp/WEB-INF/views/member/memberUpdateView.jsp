        ...
        <section class="contact-section" style='padding: 0 0 100px;'>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form action="/member/memberUpdate" class="form-contact contact_form" method="post" id="regForm">
                            <div class="row">
                                <div class="col-sm-7">
                                    <div class="form-group">
                                    	<div>아이디</div>
                                        <input class="form-control valid" id="userId" name="userId" type="text" value="${member.userId}" readonly="readonly" />
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-7">
                                    <div class="form-group">
                                    	<div>이름</div>
                                        <input class="form-control" id="userName" name="userName" type="text"  value="${member.userName}"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
									<input type="text" name="addr1" id ="addr1" placeholder="Postal Code" readonly="readonly" 
										...
										class="single-input" value = "${member.addr1}">
										</div>
										</div>
										<div class="col-sm-7">
										<div class="form-group">
									<input type="text" name="addr2" id ="addr2" placeholder="Street Address" readonly="readonly"
										onfocus="this.placeholder = ''"  required
										class="single-input" value = "${member.addr2}">
										</div>
										</div>
											<div class="col-sm-5">
											<div class="form-group">
										...
										onfocus="this.placeholder = ''"  required
										class="single-input" value = "${member.addr3}">
										</div>
										</div>
										</div>
										<br><br>
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" class="button button-contactForm boxed-btn" id="submit">수정</button>
                                <button class="button button-contactForm boxed-btn cencle" type="button">취소</button>
                                <button class="button button-contactForm boxed-btn remove" type="button">탈퇴</button>
                            </div>
                        </form>
